...
class Mensajes {
    ...
    object informacion{
        ...
        const val MODIFICACION_CREDENCIALES_FALLIDA = "Ha ocurrido un error, puede que las credenciales no se hayan modificado, no todas las credenciales se hayan modificado"
    }
}